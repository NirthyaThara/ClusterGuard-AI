      ...
      <div className="map-canvas">
              ...
              >
                <Tooltip direction="center" opacity={0.9} permanent={false}>
                  <div style={{ textAlign: "center", padding: "2px 4px" }}>
                    <div style={{ fontWeight: "bold", color: "#ff4d6a" }}>Impact Zone ({impactRadiusKm} km)</div>
        ...
        <div className="legend">
          <div className="legend-item" title="Primary industrial facility being monitored">
            <span className="legend-swatch" style={{ background: "var(--red)", border: "1.5px solid #fff" }} />
            Source Plant
          </div>
          <div className="legend-item" title="Sensitive community/ecological point inside the impact zone">
            <span className="legend-swatch" style={{ background: "#f97316", boxShadow: "0 0 5px rgba(249,115,22,0.8)" }} />
            Affected Location
          </div>
          ...
          <div className="legend-item" title="Predicted circular zone of environmental impact">
            <span className="legend-swatch" style={{ background: "rgba(255,77,106,0.25)", border: "1px dashed var(--red)" }} />
            Impact Area ({impactRadiusKm} km)
          </div>
        </div>
      </div>
    </div>
